export const ContentWrintingData = [
  {
    ...
    services: {
      heading: "All-in-one Content Writing  Services",
      serviceCard: [
        {
          id: "sev1",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "We start by understanding your brand’s voice, tone, and personality during the initial consultation phase. Our content writers in Bangalore then work closely with you to ensure that the content aligns perfectly with your brand identity and values.",
      },
      {
        id: "faq3",
        question:
          "How does Nummero stay updated with the latest content trends and best practices?",
        answer:
          "At Nummero, we prioritize continuous learning and staying updated with the latest content trends and best practices. Our team of content writers in Bangalore regularly conducts research to ensure that our content strategies are always innovative and effective.",
      },
      {
        id: "faq4",
        question:
          "How does Nummero ensure content originality and avoid plagiarism?",
        answer:
          "Nummero Company prioritizes content originality and integrity, employing plagiarism detection tools and conducting thorough checks to ensure that all content is unique and free from plagiarism.",
      },
      {
        id: "faq5",
        question:
          "What is Nummero’s approach to content collaboration and client feedback incorporation?",
        answer:
          "Nummero values collaboration and client feedback throughout the content creation process, providing multiple opportunities for input and review. Our team actively seeks client feedback and incorporates it into content revisions.",
      },
      {
        id: "faq6",
        question:
          "Can Nummero help my business improve its search engine rankings through content?",
        answer:
          "Yes, improving search engine rankings through content is one of our core specialties. We create high-quality, SEO-friendly content that is optimized for relevant keywords and helps businesses rank higher in search engine results.",
      },
    ],
    otherService: [
