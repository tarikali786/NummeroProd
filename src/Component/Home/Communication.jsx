      ...
      <div className="flex justify-between flex-col lg:flex-row items-stretch gap-6 mt-10 ">
        <div className="w-full lg:w-[75%] ">
          <div className=" flex  justify-between gap-6  items-stretch flex-col lg:flex-row">
            <div className="w-full lg:w-[65%] communicationCard items-center px-6 py-10 flex  justify-between gap-6 rounded-xl">
              <div className="w-[60%]">
              ...
              <div className="w-[40%]">
                <img
                  src="https://theme.creativemox.com/digimax/wp-content/uploads/sites/7/2024/01/imac_img.png"
                  alt=""
                />
              </div>
            </div>
            
            <div className="bg-[#2b2338] lg:h-auto  h-[30vh] w-full lg:w-[35%]  rounded-xl boottraffic flex  flex-col   justify-center px-4">
          ...
          <div className=" flex  justify-between gap-6 flex-col-reverse items-stretch mt-6 lg:flex-row-reverse">
            <div className="w-full lg:w-[65%] ResponsiveCard items-center px-6 py-10 flex  justify-between gap-6 rounded-xl">
              <div className="w-[60%]">
              ...
              <div className="w-[40%]">
                <img
                  src="https://theme.creativemox.com/digimax/wp-content/uploads/sites/7/2024/01/mobile_app.png"
                  alt=""
                />
              </div>
            </div>
            <div className="bg-[#2b2338] w-full lg:w-[35%]  rounded-xl VlaueContainer flex  flex-col  items-center justify-center px-4 lg:py-10 py-12">
        ...
        <div className=" w-full lg:w-[25%]   callContainer flex flex-col items-center justify-center rounded-lg px-10 text-center gap-6 lg:py-10 py-12">
